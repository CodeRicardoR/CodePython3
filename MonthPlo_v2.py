	...
	for NameFile in ListFiles:
		...
		for i in lines:
			...
			try:
				...
				DataH[time_data] = float(a[6]) - base
...
PathData = "/media/ricardo/1030FD8330FD6FD8/Users/ricar/Documents/Python/jica/DataMin"
Month = 9
DataYea = '2023'
...
l_base = {'jic':24750.0, 'are':22875.0}
...
ListFiles.sort()
DataJica = GetData(ListFiles, l_base['jic'], days)
