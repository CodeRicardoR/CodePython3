...
TS1 = [round(TSMin)]
for j in range(5000):
    if (TSMin + j*0.02) < TSMax:
        TS1.append(round(TSMin) + j*0.02)
...
#plt.savefig('/home/ricardo/Documents/MagnetTUMIMED/2022/Images/SC-X_' + titulo + '.png' ,bbox_inches="tight")
plt.show()
...
ax.legend(shadow=False,loc='best',bbox_to_anchor=(0.90, 0.30),fontsize = 12)
#plt.savefig('/home/ricardo/Documents/MagnetTUMIMED/2022/Images/SC-Y_' + titulo + '.png' ,bbox_inches="tight")
plt.show()
...
ax.legend(shadow=False,loc='best',bbox_to_anchor=(0.90, 0.30),fontsize = 12)
#plt.savefig('/home/ricardo/Documents/MagnetTUMIMED/2022/Images/SC-Z_' + titulo + '.png' ,bbox_inches="tight")
plt.show()
...
ax.legend(shadow=False,loc='best',bbox_to_anchor=(0.90, 0.30),fontsize = 12)
#plt.savefig('/home/ricardo/Documents/MagnetTUMIMED/2022/Images/SC-TC_' + titulo + '.png' ,bbox_inches="tight")
plt.show()
...
ax.legend(shadow=False,loc='best',bbox_to_anchor=(0.90, 0.30),fontsize = 12)
#plt.savefig('/home/ricardo/Documents/MagnetTUMIMED/2022/Images/SC-TS_' + titulo + '.png' ,bbox_inches="tight")
plt.show()
